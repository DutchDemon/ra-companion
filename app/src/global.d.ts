...
declare global {
  ...
  interface AchievementLibraryGame {
    gameId: number;
    title: string;
    ...
    achievements: any[] | Record<string, any>;
    lastSyncedAt: number;
  }
  ...
  interface Window {
    raCompanion: {
      ...
      getAchievementLibrary: () => Promise<AchievementLibrary>;
      refreshAchievementLibrary: () => Promise<AchievementLibrary>;
