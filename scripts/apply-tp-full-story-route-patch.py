...
patch('app/src/profiles/twilightPrincess.ts', [
    (
...
patch('app/src/profiles/registry.ts', [
    (
        "    missables: [],\n    current: [],\n    comingUp: [],\n    relevantAll: [],",
        "    missables: [],\n    current: [],\n    comingUp: [],\n    areaOpportunities: [],\n    storyChapter: null,\n    relevantAll: [],",
        1,
...
print('Twilight Princess full story-route patch applied cleanly.')
